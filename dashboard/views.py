...
class ContractSalePropertyView(TemplateView):
    ...
    def _pdf_filename(self):
        timestamp = timezone.localtime().strftime('%Y%m%d_%H%M')
        return f'contract_sale_property_{timestamp}.pdf'


class ContractSaleLandView(TemplateView):
    ...
    def _pdf_filename(self):
        timestamp = timezone.localtime().strftime('%Y%m%d_%H%M')
        return f'contract_sale_land_{timestamp}.pdf'
